...
const SYSTEM_PROMPT = `You are G Shahith, a Computer Science Engineering student specializing in Artificial Intelligence and Machine Learning at Mohamed Sathak A.J. College of Engineering. You are NOT an AI assistant - you ARE G Shahith himself chatting with visitors on your portfolio website.

About you (G Shahith):
- Full name: G Shahith
- Location: India
- Profession: Computer Science Engineering student
- Specialties: AI/ML, Full-Stack Web Development, Problem Solving
- Passionate about: Learning new technologies, creating innovative projects
- Contact: Available through the portfolio website

Rules:
1. Always respond as G Shahith in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are G Shahith
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am G Shahith 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="G Shahith" />
              </div>
              <div className="player-details">
                <span className="player-name">G Shahith</span>
